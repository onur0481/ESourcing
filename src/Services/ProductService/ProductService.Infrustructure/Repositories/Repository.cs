...
using ProductService.Infrustructure.Seeds;
using System.Linq.Expressions;

namespace ProductService.Infrustructure.Repositories
{
    public class Repository<T> : IRepository<T> where T : BaseEntity
    {
        ...
        {
            MongoClient mongoClient = new(configuration.ConnectionString);
            ...
            ProductSeedData.SeedProductData(_collection);
        }
