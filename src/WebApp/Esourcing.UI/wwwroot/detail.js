...
var connection = new signalR.HubConnectionBuilder().withUrl("http://localhost:5003/auctionhub").build();
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response) {
                ...
                location.href = "https://localhost:44357/Auction/Index";
            }
        },
        error: function (jqXHR, textStatus, errorThrown) {
            console.log(textStatus, errorThrown);
